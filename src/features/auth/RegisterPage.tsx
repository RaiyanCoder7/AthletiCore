        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              required
              disabled={loading}
              className="w-full rounded-xl border border-zinc-800 bg-zinc-900/60 py-3 pl-11 pr-4 text-sm text-white placeholder:text-zinc-600 outline-none transition focus:border-blue-500 disabled:cursor-not-allowed disabled:opacity-60"
            />
          </div>
        </div>
